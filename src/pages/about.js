  ...
  <>
    ...
    <div className='page-content_wrapper'>
      ...
      <div className='page-content_block'>
        <p>
          My name is Keegan Thompson. I grew up in Dothan, Alabama. I moved to
          ...
          finishing my bootcamp. Since then, programming has become my passion and
          my career. Because of my ambition, drive, and time put into the craft
        ...
        <p>
          ...
          while giving me the time to pursue other ventures. Aside
          from working on my business, I enjoy creating, working
